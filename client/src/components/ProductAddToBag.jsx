  ...
  render() {
    ...
    return (
      <div id="bag_button_box">
          ...
          <ReactModal isOpen={this.state.showModal} style={customStyles} overlayClassName="Overlay" modalImageClassName="modalImage_open" onRequestClose={this.handleCloseModal}>
